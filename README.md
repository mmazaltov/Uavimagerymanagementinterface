...
- Вкладки «Изображения БПЛА» и «Детекция снимков» с виртуализацией сеток
- Lazy-loading превью и ограничение количества карточек с кнопкой «Показать ещё»
- Генерация миниатюр для снимков (сохранение в storage и повторное использование)
